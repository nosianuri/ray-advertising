...
const Contact = () => {
  ...
  return (
    ...
    <div className='text-center pb-5 '>
            <p className='text-4xl pb-3 text-secondary'>
            CONTACT US
            </p>
        ...
        <div className=''>
            ...
            <button class="btn btn-secondary rounded-full lg:px-32 font-large text-xl text-white border-2 border-blue  group relative flex items-center overflow-hidden">
