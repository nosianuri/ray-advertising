...
const Banner = () => {
  ...
  <div class="hero-content flex-col lg:flex-row-reverse">
    <img src={tower} class="max-w-sm rounded-lg shadow-2xl" alt='tower' data-aos="fade-up"/>
    <div className='text-white lg:pr-32'>
      ...
      <button class="btn btn-primary lg:px-32 font-medium text-white border-2 border-blue py-4 group relative flex items-center overflow-hidden mt-5">
