...
const UpperFooter = () => {
  return (
    ...
    <div className='grid grid-cols-1 lg:grid-cols-2 gap-5 px-12 py-10'>
        <div>
            <p className='text-sm text-secondary'>NEED MORE BUSINESS</p>
            <div className='flex'>
            <i class="fa-solid fa-circle text-8xl text-[#FFD124] -top-[-30px] relative"></i>
            <h2 className='text-4xl relative -top-[-25px] -left-[95px] font-semibold leading-normal'>Lets Get In Touch <span className='text-secondary'>With Our Team</span> Professionals</h2>
            </div>
        ...
        <div className='pt-8'>
            ...
            <button class="btn btn-secondary rounded-full lg:px-5   text-white border-2 border-blue  group relative flex items-center overflow-hidden mt-5">
