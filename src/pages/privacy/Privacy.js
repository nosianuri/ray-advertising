  ...
  return (
    <div className='privacy'>
      <div className='lg:p-16'>
        ...
        <h2 className='lg:text-3xl sm:text-2xl mb-3'>MEDIA</h2>
        ...
        <h2 className='lg:text-3xl sm:text-2xl mb-3'>COOKIES</h2>
        ...
        <h2 className='lg:text-3xl sm:text-2xl mb-3'>EMBEDDED CONTENT FROM OTHER WEBSITES</h2>
        ...
        <h2 className='lg:text-3xl sm:text-2xl mb-3'>WHO WE SHARE YOUR DATA WITH</h2>
        ...
        <h2 className='lg:text-3xl sm:text-2xl mb-3'>HOW LONG WE RETAIN YOUR DATA</h2>
        ...
        <h2 className='lg:text-3xl sm:text-2xl mb-3'>WHAT RIGHTS YOU HAVE OVER YOUR DATA</h2>
        ...
        <h2 className='lg:text-3xl sm:text-2xl mb-3'>WHERE YOUR DATA IS SENT</h2>
