  ...
  return (
    <div className=''>
      <div className='lg:p-16'>
        <h2 className='lg:text-3xl sm:text-2xl font-bold mb-3 pt-16'>WHO WE ARE</h2>
        ...
        <h2 className='lg:text-3xl sm:text-2xl font-bold mb-3'>COMMENTS</h2>
        ...
        <h2 className='lg:text-3xl sm:text-2xl font-bold mb-3'>MEDIA</h2>
        <p className='mb-5'><span className='font-bold'>Suggested text:</span> If you upload images to the website, you should avoid uploading images with embedded location data (EXIF GPS) included. Camp lejeune cancer lawsuit
          website can download and extract any location data from images on the website.</p>
        <h2 className='lg:text-3xl sm:text-2xl font-bold mb-3'>COOKIES</h2>
        ...
        <h2 className='lg:text-3xl sm:text-2xl font-bold mb-3'>EMBEDDED CONTENT FROM OTHER WEBSITES</h2>
        ...
        <h2 className='lg:text-3xl sm:text-2xl font-bold mb-3'>WHO WE SHARE YOUR DATA WITH</h2>
        <p className='mb-5'><span className='font-bold'>Suggested text:</span> If you request a password reset, your IP address will be included in the reset email.</p>
        <h2 className='lg:text-3xl sm:text-2xl font-bold mb-3'>HOW LONG WE RETAIN YOUR DATA</h2>
        ...
        <h2 className='lg:text-3xl sm:text-2xl font-bold mb-3'>WHAT RIGHTS YOU HAVE OVER YOUR DATA</h2>
        ...
        <h2 className='lg:text-3xl sm:text-2xl font-bold mb-3'>WHERE YOUR DATA IS SENT</h2>
        <p className='mb-5'><span className='font-bold'>Suggested text:</span> Visitor comments may be checked through an automated spam detection service.</p>
      </div>
    </div>
  )
}
